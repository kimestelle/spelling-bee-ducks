  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useState2 = React6.useState, useEffect3 = React6.useEffect, useLayoutEffect3 = React6.useLayoutEffect, useDebugValue2 = React6.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef4 = React6.useRef, useEffect3 = React6.useEffect, useMemo4 = React6.useMemo, useDebugValue2 = React6.useDebugValue;
...
var require_react_is_development = __commonJS({
  "node_modules/@hello-pangea/dnd/node_modules/react-is/cjs/react-is.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
var require_react_is = __commonJS({
  "node_modules/@hello-pangea/dnd/node_modules/react-is/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
function useStyleMarshal(contextId, nonce) {
  ...
  const alwaysRef = (0, import_react3.useRef)(null);
  const dynamicRef = (0, import_react3.useRef)(null);
...
function useFocusMarshal(contextId) {
  const entriesRef = (0, import_react3.useRef)({});
  const recordRef = (0, import_react3.useRef)(null);
  const restoreFocusFrameRef = (0, import_react3.useRef)(null);
...
function useRegistry() {
  ...
  (0, import_react3.useEffect)(() => {
    return function unmount() {
      if (import_react3.default.version.startsWith("16") || import_react3.default.version.startsWith("17")) {
...
var StoreContext = import_react3.default.createContext(null);
var getBodyElement = () => {
...
function useAnnouncer(contextId) {
  ...
  (0, import_react3.useEffect)(function setup() {
...
var useUniqueId$1 = "useId" in import_react3.default ? useUniqueId : useDeprecatedUniqueId;
...
function useHiddenTextElement({
  ...
  (0, import_react3.useEffect)(function mount() {
    const el = document.createElement("div");
    el.id = id;
    el.textContent = text;
...
var AppContext = import_react3.default.createContext(null);
...
function useStartupValidation() {
  useDevSetupWarning(() => {
    checkReactVersion(peerDependencies.react, import_react3.default.version);
    checkDoctype(document);
  }, []);
}
function usePrevious(current) {
  const ref2 = (0, import_react3.useRef)(current);
  (0, import_react3.useEffect)(() => {
...
function useMouseSensor(api) {
  const phaseRef = (0, import_react3.useRef)(idle$1);
  const unbindEventsRef = (0, import_react3.useRef)(noop$2);
...
function useKeyboardSensor(api) {
  const unbindEventsRef = (0, import_react3.useRef)(noop$1);
  const startCaptureBinding = useMemo(() => ({
    eventName: "keydown",
...
function useTouchSensor(api) {
  const phaseRef = (0, import_react3.useRef)(idle);
  const unbindEventsRef = (0, import_react3.useRef)(noop$2);
...
function useSensorMarshal({
  ...
  const lockAPI = (0, import_react3.useState)(() => create())[0];
...
function App(props) {
  ...
  const lazyStoreRef = (0, import_react3.useRef)(null);
  ...
  return import_react3.default.createElement(AppContext.Provider, {
    value: appContext
  }, import_react3.default.createElement(Provider_default, {
...
var useUniqueContextId$1 = "useId" in import_react3.default ? useUniqueContextId : useDeprecatedUniqueContextId;
function resetServerContext() {
  if ("useId" in import_react3.default) {
...
function DragDropContext(props) {
  ...
  return import_react3.default.createElement(ErrorBoundary, null, (setCallbacks) => import_react3.default.createElement(App, {
    nonce: props.nonce,
    contextId,
    setCallbacks,
    dragHandleUsageInstructions: dragHandleUsageInstructions2,
...
function useDraggablePublisher(args) {
  ...
  const publishedRef = (0, import_react3.useRef)(entry);
  const isFirstPublishRef = (0, import_react3.useRef)(true);
  useLayoutEffect2(() => {
...
var DroppableContext = import_react3.default.createContext(null);
...
function useClonePropValidation(isClone) {
  useDev(() => {
    const initialRef = (0, import_react3.useRef)(isClone);
    useDevSetupWarning(() => {
...
function useRequiredContext(Context) {
  const result = (0, import_react3.useContext)(Context);
...
var Draggable = (props) => {
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, children(provided, mapped.snapshot, rubric));
};
...
function PrivateDraggable(props) {
  ...
  return import_react3.default.createElement(ConnectedDraggable$1, props);
}
function PublicDraggable(props) {
  const isEnabled = typeof props.isDragDisabled === "boolean" ? !props.isDragDisabled : true;
  const canDragInteractiveElements = Boolean(props.disableInteractiveElementBlocking);
  const shouldRespectForcePress = Boolean(props.shouldRespectForcePress);
  return import_react3.default.createElement(PrivateDraggable, _extends({}, props, {
    isClone: false,
    isEnabled,
    canDragInteractiveElements,
    shouldRespectForcePress
...
function useDroppablePublisher(args) {
  const whileDraggingRef = (0, import_react3.useRef)(null);
  ...
  const publishedDescriptorRef = (0, import_react3.useRef)(descriptor);
...
var Placeholder = (props) => {
  const animateOpenTimerRef = (0, import_react3.useRef)(null);
  ...
  const [isAnimatingOpenOnMount, setIsAnimatingOpenOnMount] = (0, import_react3.useState)(props.animate === "open");
  (0, import_react3.useEffect)(() => {
    if (!isAnimatingOpenOnMount) {
      return noop;
    }
  ...
  return import_react3.default.createElement(props.placeholder.tagName, {
    style: style2,
...
var Placeholder$1 = import_react3.default.memo(Placeholder);
...
var AnimateInOut = class extends import_react3.default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
...
var Droppable = (props) => {
  const appContext = (0, import_react3.useContext)(AppContext);
  !appContext ? true ? invariant(false, "Could not find app context") : invariant(false) : void 0;
  const {
    contextId,
    isMovementAllowed: isMovementAllowed2
  } = appContext;
  const droppableRef = (0, import_react3.useRef)(null);
  const placeholderRef = (0, import_react3.useRef)(null);
  const {
    children,
    droppableId,
    type,
  ...
  const placeholder2 = useMemo(() => import_react3.default.createElement(AnimateInOut, {
    ...
    data,
    animate
  }) => import_react3.default.createElement(Placeholder$1, {
    placeholder: data,
    onClose,
  ...
  function getClone() {
    ...
    const node = import_react3.default.createElement(PrivateDraggable, {
  ...
  return import_react3.default.createElement(DroppableContext.Provider, {
