...
// node_modules/use-fit-text/dist/index.js
var require_dist = __commonJS({
  "node_modules/use-fit-text/dist/index.js"(exports, module) {
    var e;
    var n = require_react();
    var t = (e = (init_ResizeObserver_es(), __toCommonJS(ResizeObserver_es_exports))) && "object" == typeof e && "default" in e ? e.default : e;
    var r = { debug: 10, info: 20, warn: 30, error: 40, none: 100 };
    ...
    module.exports = function(e2) {
      ...
      var o = e2.logLevel;
      void 0 === o && (o = "info");
      var c = e2.maxFontSize;
      void 0 === c && (c = 100);
      var f = e2.minFontSize;
      void 0 === f && (f = 20);
      var u = e2.onFinish, a = e2.onStart, s = e2.resolution;
      void 0 === s && (s = 5);
      var l = r[o], S = n.useCallback(function() {
        return { calcKey: 0, fontSize: c, fontSizePrev: f, fontSizeMax: c, fontSizeMin: f };
      }, [c, f]), d = n.useRef(null), v = n.useRef(), z = n.useRef(false), m = n.useState(S), w = m[0], M = m[1], h = w.calcKey, y = w.fontSize, x = w.fontSizeMax, b = w.fontSizeMin, g = w.fontSizePrev, F = null, K = n.useState(function() {
        return new t(function() {
          F = window.requestAnimationFrame(function() {
            z.current || (a && a(), z.current = true, M(Object.assign({}, S(), { calcKey: h + 1 })));
          });
        });
      })[0];
      ...
      return n.useEffect(function() {
        0 === h || z.current || (E !== v.current && (a && a(), M(Object.assign({}, S(), { calcKey: h + 1 }))), v.current = E);
      }, [h, S, E, a]), i(function() {
        if (0 !== h) {
          var e3 = Math.abs(y - g) <= s, n2 = !!d.current && (d.current.scrollHeight > d.current.offsetHeight || d.current.scrollWidth > d.current.offsetWidth), t2 = y > g;
          if (e3) n2 && y === g ? (z.current = false, l <= r.info && console.info("[use-fit-text] reached `minFontSize = " + f + "` without fitting text")) : n2 ? M({ fontSize: t2 ? g : b, fontSizeMax: x, fontSizeMin: b, fontSizePrev: g, calcKey: h }) : (z.current = false, u && u(y));
          else {
            var i2, o2 = x, c2 = b;
            n2 ? (i2 = t2 ? g - y : b - y, o2 = Math.min(x, y)) : (i2 = t2 ? x - y : g - y, c2 = Math.max(b, y)), M({ calcKey: h, fontSize: y + i2 / 2, fontSizeMax: o2, fontSizeMin: c2, fontSizePrev: y });
          }
        }
      }, [h, y, x, b, g, u, d, s]), { fontSize: y + "%", ref: d };
    };
  }
});
